 ...
 */
// $Id: XMLGregorianCalendar.java 446598 2006-09-15 12:55:40Z jeremias $
        ...
        : java.lang.Cloneable
    {
        ...
        public virtual void setTime(int hour, int minute, int second)
        {
            ...
            setTime(
                ...
                minute,
                second,
                default(java.math.BigDecimal)//null // fractional
            );
        }
        ...
        */
        ...
        public override bool Equals(Object obj)
        {
            ...
            if (obj == null)
            {
                throw new java.lang.NullPointerException("Cannot test null for equality with this XMLGregorianCalendar");
            }

            bool result = false;

            if (obj is XMLGregorianCalendar)
            {
