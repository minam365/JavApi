 ...
 */
// $Id: Duration.java 446598 2006-09-15 12:55:40Z jeremias $
...
namespace biz.ritter.javapix.xml.datatype
{
    ...
    public abstract class Duration
    {
         ...
         */
        public javax.xml.namespacej.QName getXMLSchemaType()
        {
         ...
         */
        public bool isLongerThan(Duration duration)
        {
         ...
         * @see #compare(Duration duration)
         */
        public bool isShorterThan(Duration duration)
        {
         ...
         * @see #compare(Duration duration)
         */
        public override bool Equals(Object duration)
        {
            if (duration == null)
            {
                throw new java.lang.NullPointerException();
