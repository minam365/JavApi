...
namespace biz.ritter.javapi.io
{
    ...
    public class FileWriter : OutputStreamWriter
    {
         ...
         */
        public FileWriter(File file, bool append) :// throws IOException {
            base(new FileOutputStream(file, append))
        {
        }
        ...
        public FileWriter(String filename) ://throws IOException {
            base(new FileOutputStream(new File(filename)))
        {
        }
         ...
         *             if the {@code file} cannot be opened for writing.
         */
        public FileWriter(String filename, bool append) ://throws IOException {
            base(new FileOutputStream(filename, append))
        {
        }
    }
}
