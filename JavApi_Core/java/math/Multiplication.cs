...
namespace biz.ritter.javapi.math
{
    ...
    internal class Multiplication {
         ...
         * ({@code 10^0,10^1,...,10^9})
         */
        internal static readonly int[] tenPows = {
         ...
         * ({@code 5^0,5^1,...,5^13})
         */
        internal static readonly int[] fivePows = {
        ...
        internal static void multArraysPAP(int[] aDigits, int aLen, int[] bDigits, int bLen, int[] resDigits) {
        ...
        internal static void multPAP(int []a, int []b, int []t, int aLen, int bLen) {
            if(a == b && aLen == bLen) {
                square(a, aLen, t);
                return;
            }
         ...
         * @return the top digit of production
         */
        internal static int multiplyByInt(int[] a, int aSize, int factor) {
         ...
         */
        internal static BigInteger multiplyByPositiveInt(BigInteger val, int factor) {
            ...
            if (aNumberLength == 1) {
                ...
                int resLo = (int)res;
                int resHi = (int)java.dotnet.lang.Operator.shiftRightUnsignet (res, 32);
                return ((resHi == 0)
        ...
        internal static BigInteger pow(BigInteger baseJ, int exponent) {
            // PRE: exp > 0
            BigInteger res = BigInteger.ONE;
            BigInteger acc = baseJ;
