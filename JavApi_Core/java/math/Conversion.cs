...
namespace biz.ritter.javapi.math
{
    ...
    internal class Conversion {
         ...
         */
        protected internal static readonly int[] digitFitInInt = { -1, -1, 31, 19, 15, 13, 11,
        ...
        protected internal static readonly int[] bigRadices = { -2147483648, 1162261467,
        ...
        static long divideLongByBillion(long a) {
            ...
            if (a >= 0) {
                ...
                long bPos = java.dotnet.lang.Operator.shiftRightUnsignet(1000000000L, 1);
                quot = aPos / bPos;
                rem = aPos % bPos;
