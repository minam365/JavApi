        ...
        internal static BigInteger add(BigInteger op1, BigInteger op2) {
            ...
            if (op1Len + op2Len == 2) {
                ...
                if (op1Sign == op2Sign) {
                    res = a + b;
                    valueLo = (int) res;
                    valueHi = (int) java.dotnet.lang.Operator.shiftRightUnsignet (res, 32);
            ...
            BigInteger resJ = new BigInteger(resSign, resDigits.Length, resDigits);
            resJ.cutOffLeadingZeroes();
            return resJ;
        }
