...
namespace biz.ritter.javapi.nio
{
    ...
    public abstract class CharBuffer : Buffer, java.lang.Comparable<CharBuffer>, java.lang.CharSequence, java.lang.Appendable, java.lang.Readable {
        ...
        public override String ToString() {
            ...
            for (int i = positionJ; i < limitJ; i++) {
                strbuf.Append(get(i));
            }
         ...
         */
        public virtual int read(CharBuffer target) //throws IOException 
        {
            ...
            if (remaining == 0) {
                return limitJ > 0 && target.remaining() == 0 ? 0 : -1;
            }
            remaining = java.lang.Math.min(target.remaining(), remaining);
            if (remaining > 0) {
