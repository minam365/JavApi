...
namespace biz.ritter.javapi.nio.charset
{
    ...
    public class UnsupportedCharsetException : java.lang.IllegalArgumentException {
         ...
         */
        private static readonly long serialVersionUID = 1490765524727386367L;
         ...
         */
        public UnsupportedCharsetException(String charset) : base ("The unsupported charset name is \""+ charset+"\"."){
