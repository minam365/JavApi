...
namespace biz.ritter.javapi.nio.charset
{
     ...
     * is encountered.
     */
    public class IllegalCharsetNameException : java.lang.IllegalArgumentException {

        /*
         * This constant is used during deserialization to check the version
         * which created the serialized object.
         */
        private static readonly long serialVersionUID = 1457525358470002989L;
         ...
         */
        public IllegalCharsetNameException(String charset) : base ("The illegal charset name is \""+charset+"\"."){
