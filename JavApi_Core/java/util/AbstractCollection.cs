...
namespace biz.ritter.javapi.util
{
    ...
    public abstract class AbstractCollection<E> : Collection<E> {
        ...
        public virtual T[] toArray<T> (T[] contents) {
            ...
            /*
            int size1 = size(), index = 0;
            if (size1 > contents.Length) {
                Class<T> ct = contents.getClass().getComponentType();
        ...
        //public abstract IEnumerator<E> GetEnumerator(E e);
    }
}
