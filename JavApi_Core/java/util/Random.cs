...
namespace biz.ritter.javapi.util
{
     ...
     */
    [Serializable]
    public class Random : java.io.Serializable {
    
        private static readonly long serialVersionUID = 3905348978240129619L;
         ...
         */
        public Random() {
            setSeed(java.lang.SystemJ.currentTimeMillis() + GetHashCode());
        }
        ...
        protected int next(int bits) {
            lock (this) {
                ...
                return (int) (java.dotnet.lang.Operator.shiftRightUnsignet(seed, (48 - bits)));
            }
        }
