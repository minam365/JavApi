...
namespace biz.ritter.javapi.util
{
    ...
    public class Observable {
        ...
        protected internal List<Observer> observers = new ArrayList<Observer>();
         ...
         */
        public virtual void deleteObserver(Observer observer)
        {
            lock (this) {
         ...
         */
        public virtual void notifyObservers(Object data)
        {
            int size = 0;
            ...
            if (arrays != null) {
                foreach (Observer observer in arrays) {
