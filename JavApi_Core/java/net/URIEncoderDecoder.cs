...
namespace biz.ritter.javapi.net
{
     ...
     */
    internal class URIEncoderDecoder {

        internal const String digits = "0123456789ABCDEF"; //$NON-NLS-1$
         ...
         *            s
         */
        internal static void validate(String s, String legal) {// throws URISyntaxException {
