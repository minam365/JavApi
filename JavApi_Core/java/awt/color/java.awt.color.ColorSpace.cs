 ...
 */
    ...
    [Serializable]
public abstract class ColorSpace : java.io.Serializable {

    private static readonly long serialVersionUID = -409452704308689724L;
    ...
    public String getName(int idx) {
        if (idx < 0 || idx > numComponents - 1) {
            ...
            throw new java.lang.IllegalArgumentException("Invalid component index: "+ idx); //$NON-NLS-1$
        }
    ...
    public virtual float getMinValue(int component) {
        if (component < 0 || component > numComponents - 1) {
            // awt.16A=Invalid component index: {0}
            throw new java.lang.IllegalArgumentException("Invalid component index: "+ component); //$NON-NLS-1$
        }
        return 0;
    }
    ...
    public static ColorSpace getInstance(int colorspace) {
        ...
        throw new java.lang.IllegalArgumentException("Not a predefined colorspace"); //$NON-NLS-1$
    }
}}
