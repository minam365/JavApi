...
*/
         ...
         * @return this StringBuffer.
         */
        public java.lang.StringBuffer append(String s) {
            lock (this) {
                append0(s);
                return this;
            }
         ...
         * @since 1.4
         */
        public java.lang.StringBuffer append(StringBuffer sb) {
            lock (this) {
                if (sb == null) {
                    appendNull();
                } else {
         ...
         *            if {@code chars} is {@code null}.
         */
        public java.lang.StringBuffer append(char [] chars, int start, int length) {
            lock (this) {
         ...
         * @since 1.5
         */
        public java.lang.StringBuffer append(CharSequence s) {
            lock (this){
                if (s == null) {
                    appendNull();
                } else {
         ...
         * @since 1.5
         */
        public java.lang.StringBuffer append(CharSequence s, int start, int end) {
            lock(this) {
                append0(s, start, end);
                return this;
            }
         ...
         *             if {@code index &lt; 0} or {@code index &gt; length()}.
         */
        public java.lang.StringBuffer insert(int index, String s) {
            lock (this){
                insert0(index, s);
                return this;
            }
         ...
         *             length()}
         */
        public java.lang.StringBuffer insert(int index, char[] chars, int start,
                int length) {
            lock (this) {
         ...
         *             the length of {@code s}.
         */
        public java.lang.StringBuffer replace(int start, int end, String s) {
            lock (this) {
