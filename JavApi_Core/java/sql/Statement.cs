...
namespace biz.ritter.javapi.sql
{
     ...
     */
    public interface Statement : Wrapper
    {
         ...
         *             if an error occurs accessing the database.
         */
        bool execute(String sql);// throws SQLException;
         ...
         *             if an error occurs accessing the database.
         */
        bool execute(String sql, int[] columnIndexes);// throws SQLException;
         ...
         *             if an error occurs accessing the database.
         */
        bool getMoreResults();// throws SQLException;
         ...
         *             if an error occurs accessing the database.
         */
        bool getMoreResults(int current);// throws SQLException;
         ...
         *             if an error occurs accessing the database.
         */
        void setEscapeProcessing(bool enable);// throws SQLException;
        ...
        void setPoolable(bool poolable);// throws SQLException;

        bool isPoolable();// throws SQLException;
    }

    public sealed class StatementConstants
    {
         /*
