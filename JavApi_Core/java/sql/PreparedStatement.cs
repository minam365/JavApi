...
namespace biz.ritter.javapi.sql
{
    ...
    public interface PreparedStatement : Statement
    {
         ...
         *             if a database error happens.
         */
        void setAsciiStream(int parameterIndex, java.io.InputStream theInputStream,
         ...
         *             if a database error happens.
         */
        void setBinaryStream(int parameterIndex, java.io.InputStream theInputStream,
                int length);// throws SQLException;
         ...
         *             if a database error happens.
         */
        void setInt(int parameterIndex, int theInt);// throws SQLException;
         ...
         * @see URL
         */
        void setURL(int parameterIndex, java.net.URL theURL);// throws SQLException;
        ...
        void setClob(int parameterIndex, java.io.Reader reader);// throws SQLException;

        void setBlob(int parameterIndex, java.io.InputStream inputStream)
               ;// throws SQLException;

        void setNClob(int parameterIndex, java.io.Reader reader);// throws SQLException;
    }
