...
namespace org.apache.harmony.awt.gl
{
    ...
    internal class Crossing
    {
        ...
        public static int solveCubic(double[] eqn, double[] res)
        {
            ...
            if (R2 < Q3)
            {
                double t = java.lang.Math.acos(R / java.lang.Math.sqrt(Q3)) / 3.0;
                double p = 2.0 * java.lang.Math.PI / 3.0;
                double m = -2.0 * java.lang.Math.sqrt(Q);
                res[rc++] = m * java.lang.Math.cos(t) + n;
                res[rc++] = m * java.lang.Math.cos(t + p) + n;
                res[rc++] = m * java.lang.Math.cos(t - p) + n;
            }
            else
            {
                //          Debug.println("R2 >= Q3 (" + R2 + "/" + Q3 + ")");
                double A = java.lang.Math.pow(java.lang.Math.abs(R) + java.lang.Math.sqrt(R2 - Q3), 1.0 / 3.0);
                if (R > 0.0)
                {
                    A = -A;
                }
        ...
        public class QuadCurve
        {
            ...
            internal int cross(double[] res, int rc, double py1, double py2)
            {
                int cross = 0;
            ...
            internal int solvePoint(double[] res, double px)
            {
                double[] eqn = { -px, Bx, Ax };
                return solveQuad(eqn, res);
            }

            internal int solveExtrem(double[] res)
            {
                int rc = 0;
                if (Ax != 0.0)
                {
            ...
            internal int addBound(double[] bound, int bc, double[] res, int rc, double minX, double maxX, bool changeId, int id)
            {
                for (int i = 0; i < rc; i++)
                {
                    double t = res[i];
        ...
        public class CubicCurve
        {
            ...
            internal double ax, ay, bx, by, cx, cy;
            ...
            internal int solveExtremX(double[] res)
            {
                double[] eqn = { Cx, Bx2, Ax3 };
                return solveQuad(eqn, res);
            }

            internal int solveExtremY(double[] res)
            {
        ...
        static int crossBound(double[] bound, int bc, double py1, double py2)
        {
            ...
            if (up != 0)
            {
                // bc >= 2
                sortBound(bound, bc);
                bool sign = bound[2] > py2;
                for (int i = 6; i < bc; i += 4)
                {
                    bool sign2 = bound[i] > py2;
